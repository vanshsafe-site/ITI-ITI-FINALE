...
export function FreePreviewVideo() {
  ...
  return (
    <div style={{ margin: "40px 0", padding: "24px", background: "rgba(167,180,230,0.12)", border: "1px solid rgba(117,146,101,0.18)", borderRadius: 24, boxSizing: "border-box", overflow: "hidden" }}>
      <div
        style={{
          fontSize: "0.75rem",
          letterSpacing: "0.1em",
